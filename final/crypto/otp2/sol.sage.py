...
_sage_const_6 = Integer(6); _sage_const_19622 = Integer(19622); _sage_const_1 = Integer(1); _sage_const_13 = Integer(13); _sage_const_5 = Integer(5); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_40 = Integer(40); _sage_const_110 = Integer(110); _sage_const_90 = Integer(90); _sage_const_7 = Integer(7); _sage_const_10 = Integer(10); _sage_const_100 = Integer(100); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_16 = Integer(16)
from pwn import *
from secrets import randbits

n = _sage_const_6 
while True:
    r = remote("34.124.157.94", _sage_const_19622 )
...
g = GF(p)((_sage_const_5  * _sage_const_7 )**_sage_const_10 )
